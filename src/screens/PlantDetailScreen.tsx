...
function HealthBar({ plant }: { plant: Plant }) {
  ...
  // Animate bar width (layout prop → useNativeDriver: false)
...
const styles = StyleSheet.create({
  ...
  heroEmojiCircle: { width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(255,255,255,0.15)', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: 'rgba(255,255,255,0.3)', marginBottom: Spacing.sm },
